...
<nav class="navbar navbar-expand-md navbar-dark bg-primary">
    ...
    <div class="container bg-white">
        <div class="p-4 bg-primaryx  text-white rounded">
            <h1 class="mb-0">HAPUS DATA ASISTEN</h1>
        </div>
        <form action="/asisten/delete" method="post">
            <?= csrf_field() ?>
            <div class="p-4 bg-primary rounded mt-3">
                ...
                <button type="submit" class="btn btn-warning"><i class="fas fa-trash-alt"></i> Hapus</button>
            </div>
            </div>
            </div>
        </form>
